...
- TTS: measure RTF and run an internal MOS (mean opinion score) panel — a handful of native speakers per language rating naturalness 1-5 is enough for hackathon-scale validation.
